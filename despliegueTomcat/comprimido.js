...
class AnimatedSpriteSheet extends react_1.default.Component {
    constructor(props) {
        super(props);
        this.timerId = -1;
        this.isPlaying = true;
    ...
    shouldComponentUpdate(nextProps, nextState) {
        if (!shallowequal_1.shallowEqual(this.props.bounds, nextProps.bounds)) {
            return true;
        }
        if (!shallowequal_1.shallowEqual({
        ...
        if (!shallowequal_1.shallowEqual(this.state, nextState)) {
            return true;
        }
        return false;
    }
    render() {
        ...
        return react_1.default.createElement(Sprite_1.Sprite, Object.assign({}, spriteData));
    }
}
/*static propTypes = {
...
},{"./Sprite":3,"./shallowequal":28,"react":26}],3:[function(require,module,exports){
"use strict";
var __importDefault = (this && this.__importDefault) || function (mod) {
    return (mod && mod.__esModule) ? mod : { "default": mod };
};
...
class Sprite extends react_1.default.Component {
    render() {
        ...
        return react_1.default.createElement("div", { style: estilo });
    }
}
Sprite.defaultProps = {
    x: 0,
...
},{"./emptyFunction":8,"_process":1}],18:[function(require,module,exports){
/*
object-assign
(c) Sindre Sorhus
@license MIT
...
},{"./lib/ReactPropTypesSecret":20,"_process":1}],20:[function(require,module,exports){
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
},{"_process":1,"fbjs/lib/ExecutionEnvironment":4,"fbjs/lib/camelizeStyleName":6,"fbjs/lib/containsNode":7,"fbjs/lib/emptyFunction":8,"fbjs/lib/emptyObject":9,"fbjs/lib/getActiveElement":10,"fbjs/lib/hyphenateStyleName":12,"fbjs/lib/invariant":13,"fbjs/lib/shallowEqual":16,"fbjs/lib/warning":17,"object-assign":18,"prop-types/checkPropTypes":19,"react":26}],22:[function(require,module,exports){
/** @license React v16.4.1
...
},{"_process":1,"fbjs/lib/emptyFunction":8,"fbjs/lib/emptyObject":9,"fbjs/lib/invariant":13,"fbjs/lib/warning":17,"object-assign":18,"prop-types/checkPropTypes":19}],25:[function(require,module,exports){
/** @license React v16.4.1
...
const AnimatedSpriteSheet_1 = require("./AnimatedSpriteSheet");
function PersonaCorriendo() {
    return (react_1.default.createElement(AnimatedSpriteSheet_1.AnimatedSpriteSheet, { filename: "axe8.png", bounds: { x: 0, y: 0, width: 1024, height: 489 }, speed: 400, marcosPorFila: 8, numeroFilas: 3, marcosUltimaFila: 6 }));
}
function GatoCorriendo() {
    return (react_1.default.createElement(AnimatedSpriteSheet_1.AnimatedSpriteSheet, { filename: "cat-running.png", bounds: { x: 0, y: 0, width: 2048, height: 512 }, speed: 400, marcosPorFila: 4, numeroFilas: 2, marcosUltimaFila: 4 }));
}
function Ninja() {
    return (react_1.default.createElement(AnimatedSpriteSheet_1.AnimatedSpriteSheet, { filename: "billylee.png", bounds: { x: 0, y: 0, width: 1010, height: 271 }, speed: 400, marcosPorFila: 7, numeroFilas: 2, marcosUltimaFila: 5 }));
}
react_dom_1.default.render(react_1.default.createElement(PersonaCorriendo, null), document.getElementById('contenedor1'));
react_dom_1.default.render(react_1.default.createElement(GatoCorriendo, null), document.getElementById('contenedor2'));
react_dom_1.default.render(react_1.default.createElement(Ninja, null), document.getElementById('contenedor3'));

},{"./AnimatedSpriteSheet":2,"react":26,"react-dom":23}],28:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
